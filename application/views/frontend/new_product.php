				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
						<div class="page-sidebar-area">
							...
							<div class="single-sidebar shop-by-area">
								...
								<?php $this->load->view('templates/offered_products_sidebar');?>								
					...
					<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
						<div class="right-main-product">
							...
							<?php $counter = 0; foreach($new_products as $row) { $counter++;?>
									...
									<div class="single-product-item">
										...
										<div class="single-product-text">
											...
											<div class="pro-add-to-cart">
												<p><a href="<?php echo site_url('cs/single_product?id='.$row->id);?>" title="Add to Cart">View Details</a></p>
											</div>
										</div>
