    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url(); ?>">OnlineSongbad.com</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bookmark fa-fw"></i> Category <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url('admin/category?a=create'); ?>">Create Category</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bookmark-o fa-fw"></i> Sub Category <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url('admin/sub_category?a=create'); ?>">Create Sub-Category</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('admin/sub_category'); ?>">Sub-Category List</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url('admin/products?a=add'); ?>">Add News</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('admin/products'); ?>">News List</a>
                                </li>
                            </ul>
                        </li>
                        <li>
